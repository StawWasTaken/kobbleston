...
/**
 * The Kube. Inline rather than an image so it takes the colour and the size
 * of whatever it sits in, the same as every other icon on the site.
 */
export function Kube({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
