import{Mn as e,Vn as t,Yn as n,kn as r,qn as i}from"./free-solid-svg-icons-CjUTYSc8.js";import{E as a,Pn as o,X as s,gn as c,ht as l,m as u,xn as d}from"./Card-C7QiyjFO.js";import{a as f,n as p,r as m}from"./Toast-CcMVP49f.js";import{B as h}from"./app-BCZl5Wo4.js";var g=n(i(),1),_=e(),v=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),y=e=>e.replace(/"/g,`&quot;`),b=`
(function () {
