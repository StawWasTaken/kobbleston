import{Kn as e,Ln as t,Pn as n,Qn as r,er as i}from"./free-solid-svg-icons-OQKHSVG2.js";import{St as a,Wn as o,jn as s,k as c,m as l,tt as u,wn as d}from"./Card-6HvqHxCO.js";import{a as f,n as p,r as m}from"./Toast-lKKZSouA.js";import{z as h}from"./app-4kTx8590.js";var g=i(r(),1),_=t(),v=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),y=e=>e.replace(/"/g,`&quot;`),b=`
(function () {
