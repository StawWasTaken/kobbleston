import{Mn as e,Vn as t,Yn as n,kn as r,qn as i}from"./free-solid-svg-icons-CjUTYSc8.js";import{Nn as a,T as o,Y as s,bn as c,h as l,hn as u,mt as d}from"./Card-DgBsTZni.js";import{a as f,n as p,r as m}from"./Toast-DHMVWvBl.js";import{F as h}from"./app-BWolzAxl.js";var g=n(i(),1),_=e(),v=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),y=e=>e.replace(/"/g,`&quot;`),b=`
(function () {
