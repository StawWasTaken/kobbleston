import{Rn as e,Vn as t,Xn as n,ir as r,nr as i}from"./format-Dz0Sq76V.js";import{Bn as a,Dn as o,E as s,Q as c,d as l,xn as u,yt as d}from"./Card-f6yBBDnu.js";import{a as f,n as p,r as m}from"./Toast-CucjCABo.js";import{B as h,z as g}from"./app-CrW23Bi6.js";var _=r(i(),1),v=t(),y=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),b=e=>e.replace(/"/g,`&quot;`),x=`
(function () {
...
</html>`}function w({files:t,title:r,className:i,spaceId:y,building:b}){let x=n(),w=p(),{profile:T}=f(),E=(0,_.useRef)(null),[D,O]=(0,_.useState)(new Map),[k,A]=(0,_.useState)(new Map),[j,M]=(0,_.useState)(null),[N,P]=(0,_.useState)(!1),F=(0,_.useMemo)(()=>S(t),[t]);(0,_.useEffect)(()=>{let e=!0;if(!F.length){O(new Map);return}return Promise.all(F.map(async e=>d(e)?[e,await a(e).catch(()=>null)]:[e,null])).then(t=>{e&&O(new Map(t.filter(([,e])=>!!e)))}),()=>{e=!1}},[F]);let I=(0,_.useMemo)(()=>{let e=t.find(e=>e.path===`index.html`)?.content??``;return[...new Set([...e.matchAll(/data-kob-ad="([a-z]+)"/g)].map(e=>e[1]))]},[t]);(0,_.useEffect)(()=>{let e=!0;if(b||!y||!I.length){A(new Map);return}return Promise.all(I.map(async e=>{let t=await u(e,y).catch(()=>null);if(!t)return[e,null];let n=await s(t.file_path,3600).catch(()=>null);return[e,n?{ad:t,url:n}:null]})).then(t=>{e&&A(new Map(t))}),()=>{e=!1}},[I,y,b]),(0,_.useEffect)(()=>{let e=async e=>{if(e.source!==E.current?.contentWindow)return;let t=e.data;if(t&&typeof t.kob==`string`){if(t.kob===`donate`){if(b){w(`This is how it will work once it is live.`,`info`);return}if(!T){w(`Make an account to give ${g.plural}.`,`info`);return}M(Math.min(Math.max(Math.round(Number(t.amount)||0),1),1e4));return}if(t.kob===`ad-click`&&typeof t.id==`string`){if(b)return;let e=[...k.values()].find(e=>e?.ad.id===t.id);if(!e)return;await o(e.ad.id).catch(()=>{}),x(e.ad.target_path)}}};return window.addEventListener(`message`,e),()=>window.removeEventListener(`message`,e)},[k,b,x,T,w]);let L=async()=>{if(y&&j!==null){P(!0);try{let e=await c(y,j);w(`Given. You have ${g.amount(e)} left.`,`success`),M(null)}catch(e){w(e instanceof Error?e.message:`That did not go through.`,`error`)}finally{P(!1)}}},R=(0,_.useMemo)(()=>Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),[t]),z=(0,_.useMemo)(()=>C(t,D,k,R),[t,D,k,R]);return(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(`iframe`,{ref:E,title:r,srcDoc:z,sandbox:`allow-scripts`,referrerPolicy:`no-referrer`,className:e(`h-full w-full border-0 bg-white`,i)}),(0,v.jsx)(m,{open:j!==null,onClose:()=>M(null),title:`Give ${g.plural}`,description:`A gift to whoever made this Space. Nothing is promised in return.`,size:`sm`,footer:(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(l,{variant:`ghost`,onClick:()=>M(null),children:`Cancel`}),(0,v.jsxs)(l,{loading:N,onClick:L,children:[(0,v.jsx)(h,{}),`Give `,j]})]}),children:(0,v.jsxs)(`p`,{className:`text-sm leading-relaxed text-muted`,children:[`This sends `,(0,v.jsx)(`span`,{className:`font-bold text-white`,children:j}),` `,g.plural,` from your account to the owner of this Space. It cannot be taken back.`]})})]})}export{w as t};