import{Kn as e,Ln as t,Pn as n,Qn as r,er as i}from"./free-solid-svg-icons-OQKHSVG2.js";import{St as a,Wn as o,jn as s,k as c,m as l,tt as u,wn as d}from"./Card-BoVQuA0e.js";import{a as f,n as p,r as m}from"./Toast-CewaU_jR.js";import{z as h}from"./app-Dv6VTjOl.js";var g=i(r(),1),_=t(),v=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),y=e=>e.replace(/"/g,`&quot;`),b=`
(function () {
...
</html>`}function C({files:t,title:r,className:i,spaceId:v,building:y}){let b=e(),C=p(),{profile:w}=f(),T=(0,g.useRef)(null),[E,D]=(0,g.useState)(new Map),[O,k]=(0,g.useState)(new Map),[A,j]=(0,g.useState)(null),[M,N]=(0,g.useState)(!1),P=(0,g.useMemo)(()=>x(t),[t]);(0,g.useEffect)(()=>{let e=!0;if(!P.length){D(new Map);return}return Promise.all(P.map(async e=>a(e)?[e,await o(e).catch(()=>null)]:[e,null])).then(t=>{e&&D(new Map(t.filter(([,e])=>!!e)))}),()=>{e=!1}},[P]);let F=(0,g.useMemo)(()=>{let e=t.find(e=>e.path===`index.html`)?.content??``;return[...new Set([...e.matchAll(/data-kob-ad="([a-z]+)"/g)].map(e=>e[1]))]},[t]);(0,g.useEffect)(()=>{let e=!0;if(y||!v||!F.length){k(new Map);return}return Promise.all(F.map(async e=>{let t=await d(e,v).catch(()=>null);if(!t)return[e,null];let n=await c(t.file_path,3600).catch(()=>null);return[e,n?{ad:t,url:n}:null]})).then(t=>{e&&k(new Map(t))}),()=>{e=!1}},[F,v,y]),(0,g.useEffect)(()=>{let e=async e=>{if(e.source!==T.current?.contentWindow)return;let t=e.data;if(t&&typeof t.kob==`string`){if(t.kob===`donate`){if(y){C(`This is how it will work once it is live.`,`info`);return}if(!w){C(`Make an account to give Kubes.`,`info`);return}j(Math.min(Math.max(Math.round(Number(t.amount)||0),1),1e4));return}if(t.kob===`ad-click`&&typeof t.id==`string`){if(y)return;let e=[...O.values()].find(e=>e?.ad.id===t.id);if(!e)return;await s(e.ad.id).catch(()=>{}),b(e.ad.target_path)}}};return window.addEventListener(`message`,e),()=>window.removeEventListener(`message`,e)},[O,y,b,w,C]);let I=async()=>{if(v&&A!==null){N(!0);try{let e=await u(v,A);C(`Given. You have ${e} Kubes left.`,`success`),j(null)}catch(e){C(e instanceof Error?e.message:`That did not go through.`,`error`)}finally{N(!1)}}},L=(0,g.useMemo)(()=>Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),[t]),R=(0,g.useMemo)(()=>S(t,E,O,L),[t,E,O,L]);return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`iframe`,{ref:T,title:r,srcDoc:R,sandbox:`allow-scripts`,referrerPolicy:`no-referrer`,className:n(`h-full w-full border-0 bg-white`,i)}),(0,_.jsx)(m,{open:A!==null,onClose:()=>j(null),title:`Give Kubes`,description:`A gift to whoever made this Space. Nothing is promised in return.`,size:`sm`,footer:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(l,{variant:`ghost`,onClick:()=>j(null),children:`Cancel`}),(0,_.jsxs)(l,{loading:M,onClick:I,children:[(0,_.jsx)(h,{}),`Give `,A]})]}),children:(0,_.jsxs)(`p`,{className:`text-sm leading-relaxed text-muted`,children:[`This sends `,(0,_.jsx)(`span`,{className:`font-bold text-white`,children:A}),` Kubes from your account to the owner of this Space. It cannot be taken back.`]})})]})}export{C as t};