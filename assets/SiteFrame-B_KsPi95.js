import{An as e,Mn as t,Vn as n,Yn as r,qn as i}from"./free-solid-svg-icons-aglpSWAt.js";import{An as a,T as o,Y as s,_n as c,fn as l,h as u,pt as d}from"./Card-D7g9h17U.js";import{a as f,n as p,r as m}from"./Toast-Hmt-yALn.js";import{L as h}from"./app-9wGYjIvH.js";var g=r(i(),1),_=t(),v=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),y=e=>e.replace(/"/g,`&quot;`),b=`
(function () {
