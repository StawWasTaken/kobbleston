import{Dn as e,Hn as t,In as n,Tn as r,Wn as i}from"./free-solid-svg-icons-Bvf09pTG.js";import{K as a,S as o,h as s,in as c,ln as l,lt as u,vn as d}from"./Card-CxCF25yq.js";import{a as f,n as p,r as m}from"./Toast-C5AaMEJ1.js";import{D as h}from"./app-BKeYBsD4.js";var g=i(t(),1),_=e(),v=e=>[`default-src 'none'`,`img-src https: data: blob:`,`media-src https: blob:`,`font-src https: data:`,`style-src 'unsafe-inline' https:`,`script-src 'nonce-${e}'`,`form-action 'none'`,`base-uri 'none'`,`frame-src 'none'`,`connect-src 'none'`].join(`; `),y=e=>e.replace(/"/g,`&quot;`),b=`
(function () {
...
</html>`}function C({files:e,title:t,className:i,spaceId:v,building:y}){let b=n(),C=p(),{profile:w}=f(),T=(0,g.useRef)(null),[E,D]=(0,g.useState)(new Map),[O,k]=(0,g.useState)(new Map),[A,j]=(0,g.useState)(null),[M,N]=(0,g.useState)(!1),P=(0,g.useMemo)(()=>x(e),[e]);(0,g.useEffect)(()=>{let e=!0;if(!P.length){D(new Map);return}return Promise.all(P.map(async e=>u(e)?[e,await d(e).catch(()=>null)]:[e,null])).then(t=>{e&&D(new Map(t.filter(([,e])=>!!e)))}),()=>{e=!1}},[P]);let F=(0,g.useMemo)(()=>{let t=e.find(e=>e.path===`index.html`)?.content??``;return[...new Set([...t.matchAll(/data-kob-ad="([a-z]+)"/g)].map(e=>e[1]))]},[e]);(0,g.useEffect)(()=>{let e=!0;if(y||!v||!F.length){k(new Map);return}return Promise.all(F.map(async e=>{let t=await c(e,v).catch(()=>null);if(!t)return[e,null];let n=await o(t.file_path,3600).catch(()=>null);return[e,n?{ad:t,url:n}:null]})).then(t=>{e&&k(new Map(t))}),()=>{e=!1}},[F,v,y]),(0,g.useEffect)(()=>{let e=async e=>{if(e.source!==T.current?.contentWindow)return;let t=e.data;if(t&&typeof t.kob==`string`){if(t.kob===`donate`){if(y){C(`This is how it will work once it is live.`,`info`);return}if(!w){C(`Make an account to give Kubes.`,`info`);return}j(Math.min(Math.max(Math.round(Number(t.amount)||0),1),1e4));return}if(t.kob===`ad-click`&&typeof t.id==`string`){if(y)return;let e=[...O.values()].find(e=>e?.ad.id===t.id);if(!e)return;await l(e.ad.id).catch(()=>{}),b(e.ad.target_path)}}};return window.addEventListener(`message`,e),()=>window.removeEventListener(`message`,e)},[O,y,b,w,C]);let I=async()=>{if(v&&A!==null){N(!0);try{let e=await a(v,A);C(`Given. You have ${e} Kubes left.`,`success`),j(null)}catch(e){C(e instanceof Error?e.message:`That did not go through.`,`error`)}finally{N(!1)}}},L=(0,g.useMemo)(()=>Math.random().toString(36).slice(2)+Math.random().toString(36).slice(2),[e]),R=(0,g.useMemo)(()=>S(e,E,O,L),[e,E,O,L]);return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`iframe`,{ref:T,title:t,srcDoc:R,sandbox:`allow-scripts`,referrerPolicy:`no-referrer`,className:r(`h-full w-full border-0 bg-white`,i)}),(0,_.jsx)(m,{open:A!==null,onClose:()=>j(null),title:`Give Kubes`,description:`A gift to whoever made this Space. Nothing is promised in return.`,size:`sm`,footer:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(s,{variant:`ghost`,onClick:()=>j(null),children:`Cancel`}),(0,_.jsxs)(s,{loading:M,onClick:I,children:[(0,_.jsx)(h,{}),`Give `,A]})]}),children:(0,_.jsxs)(`p`,{className:`text-sm leading-relaxed text-muted`,children:[`This sends `,(0,_.jsx)(`span`,{className:`font-bold text-white`,children:A}),` Kubes from your account to the owner of this Space. It cannot be taken back.`]})})]})}export{C as t};